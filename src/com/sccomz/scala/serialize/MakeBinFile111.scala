...
object MakeBinFile111 {
  ...
  def makeEngSectorResult(scheduleId: String, cdNm: String, sectorPath: String) = {
    ...
    val bin2 = new Array[Byte4](x_bin_cnt * y_bin_cnt);
    ...
    // 파일 Write
    //---------------------------------------------------------------------------------------------------------
    var file = new File(App.resultPath, cdNm + ".bin");
    ...
    //      }
    //    }
    for (i <- 0 until bin2.length by 1) {
      fos.write(bin2(i).value);
    }
    println("====================test==============================");
    println("====================test==============================");

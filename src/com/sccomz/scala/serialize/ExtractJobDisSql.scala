...
SELECT A.SCHEDULE_ID
     ...
     , A.PCI_PORT
     , A.RU_ID
     , CONCAT('/',A.USER_ID,'/ENG_',A.ENB_ID,'/PCI_',A.PCI,'_PORT_',A.PCI_PORT,'_',A.RU_ID) AS SECTOR_PATH
     , CONCAT('/',A.USER_ID,'/ENG_',A.ENB_ID,'/PCI_',A.PCI,'_PORT_',A.PCI_PORT,'_',A.RU_ID) AS RU_PATH

...
CREATE TABLE SCHEDULE_WEIGHT (
    ...
    , 3D_W5               INT                 NULL -- 3D임계치5(RU갯수*BIN갯수+빌딩(면적*층수))
    , 3D_W4               INT                 NULL -- 3D임계치4(RU갯수*BIN갯수+빌딩(면적*층수))
    , 3D_W3               INT                 NULL -- 3D임계치3(RU갯수*BIN갯수+빌딩(면적*층수))
    , 3D_W2               INT                 NULL -- 3D임계치2(RU갯수*BIN갯수+빌딩(면적*층수))
    , 3D_W1               INT                 NULL -- 3D임계치1(RU갯수*BIN갯수+빌딩(면적*층수))

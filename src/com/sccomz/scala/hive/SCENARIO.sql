...
COMMENT 'SCENARIO'
STORED AS PARQUET
LOCATION '/user/teos/parquet/entity/SCENARIO';

--ALTER TABLE SCHEDULE ADD PARTITION (SCHEDULE_ID=8459967);
ALTER TABLE SCENARIO ADD PARTITION (SCENARIO_ID=8459967) LOCATION '/user/teos/parquet/entity/SCENARIO/SCENARIO_ID=8459967';

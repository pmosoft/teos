...
CREATE TABLE PUBLIC.I_SCENARIO_NR_RU(                                                                                                                                                                                                                                                                                                             
 SCENARIO_ID                   NUMERIC NOT NULL PRIMARY KEY                                                                                                                        
,ENB_ID                        VARCHAR(10) PRIMARY KEY                                                                                                                        
,PCI                           NUMERIC NOT NULL PRIMARY KEY                                                                                                                       
,PCI_PORT                      NUMERIC NOT NULL PRIMARY KEY                                                                                                                      
,RU_ID                         VARCHAR(48) NOT NULL PRIMARY KEY                                                                                                                      
,MAKER                         VARCHAR(30)                                                                                                                        
,SECTOR_ORD                    NUMERIC NOT NULL PRIMARY KEY                                                                                                                      
,REPEATERATTENUATION           NUMERIC                                                                                                                        
,REPEATERPWRRATIO              NUMERIC                                                                                                                        
,RU_SEQ                        NUMERIC                                                                                                                        
,RADIUS                        NUMERIC                                                                                                                        
...
,ANTENA_SEQ                    NUMERIC
,RU_ID                         VARCHAR(48) NOT NULL PRIMARY KEY
,ANTENA_NM                     VARCHAR(100) NOT NULL PRIMARY KEY
,ORIENTATION                   NUMERIC
,TILTING                       NUMERIC
,ANTENA_ORD                    NUMERIC NOT NULL PRIMARY KEY

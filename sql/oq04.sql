...
FROM   SCENARIO T_SCENARIO
     ...
     ,(SELECT SCENARIO_ID
       ...
       FROM   RU
       WHERE  SCENARIO_ID IN (SELECT SCENARIO_ID FROM SCHEDULE WHERE SCHEDULE_ID = 8463189)
...
AND    T_SITE.STATUS          = 1
AND    T_SCENARIO.SCENARIO_ID IN (SELECT SCENARIO_ID FROM SCHEDULE WHERE SCHEDULE_ID = 8463189)

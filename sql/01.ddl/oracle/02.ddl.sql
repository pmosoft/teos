...
(
 SCENARIO_ID NUMBER  
,GROUP_ID NUMBER  
,SITE_NM VARCHAR2(250)  
,STRXPOS VARCHAR2(50)  
,STRYPOS VARCHAR2(50)  
,TYPE VARCHAR2(50)  
,FA_SEQ NUMBER  
,SISUL_CD VARCHAR2(50)  
,SITE_KEY VARCHAR2(50)  
,ENB_ID NUMBER  
,PCI NUMBER  
,SITE_ADDR VARCHAR2(500)  
,DU_H_NM VARCHAR2(200)  
,SECTOR_ORD NUMBER  
,CORRECTION NUMBER  
,TOWER_HEIGHT NUMBER  
,BLD_HEIGHT NUMBER  
,ANTENA_NM1 VARCHAR2(100)  
,ORIENTATION1 NUMBER  
,ET_TILTING1 NUMBER  
,TILTING1 NUMBER  
,ANTENA_NM2 VARCHAR2(100)  
,ORIENTATION2 NUMBER  
,ET_TILTING2 NUMBER  
,TILTING2 NUMBER  
,ANTENA_NM3 VARCHAR2(100)  
,ORIENTATION3 NUMBER  
,ET_TILTING3 NUMBER  
,TILTING3 NUMBER  
,TXLAYER NUMBER  
...
,CONSTRAINT CELLDB_5G_EXCEL_IMPORT_PK PRIMARY KEY()
);
...
,RSSI_RU_DBM NUMBER  
,RSSI_RU_WATT NUMBER  
,CONSTRAINT LTE_IO_ANALYSIS_PK PRIMARY KEY()
);
...
,TXLAYER NUMBER  
,RXLAYER NUMBER  
,CONSTRAINT NRSECTORPARAMETER_PK PRIMARY KEY()
);
...
,SNR14 NUMBER  
,SNR15 NUMBER  
,CONSTRAINT NRUETRAFFIC_PK PRIMARY KEY()
);
...
,REG_DT DATE  
,UPDATE_DT DATE  
,CONSTRAINT NR_CANDIDATE_SITE_INFO_PK PRIMARY KEY()
);
...
,FONT_SIZE NUMBER  
,CONSTRAINT SITE_DRAW_OPTION_PK PRIMARY KEY()
);
...
,ANTENNA_SEQ NUMBER  
,CONSTRAINT TILT_RUNRESULT_PK PRIMARY KEY()
);
...
,CONSTRAINT TILT_SCENARIO_EVO_PK PRIMARY KEY()
);
...
,TILT_BEAM_HEIGHT_30 NUMBER  
,TILT_BEAM_HEIGHT_40 NUMBER  
,CONSTRAINT TILT_SCENARIO_FINE_PK PRIMARY KEY()
);
...
,TILT_ORD NUMBER  
,TILT_BASE NUMBER  
,CONSTRAINT TILT_TARGET_INFO_PK PRIMARY KEY()
);
--DROP TABLE CELLPLAN.ANALYSIS_LIST;
CREATE TABLE CELLPLAN.ANALYSIS_LIST
(

...
CREATE TABLE TSKGHFE01 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFE01@KGH001 WHERE 체결년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFD01 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFD01@KGH001 WHERE 처리년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFD02 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFD02@KGH001 WHERE 처리년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFD05 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFD05@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFD06 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFD06@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFD11 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFD11@KGH001 WHERE 처리년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFC41 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFC41@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFF01 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFF01@KGH001 WHERE 처리년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHFF05 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHFF05@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSA04 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSA04@KGH001 WHERE 처리년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE07 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE07@KGH001 WHERE 거래년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE16 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE16@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE17 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE17@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE18 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE18@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE19 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE19@KGH001 WHERE 평가년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE54 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE54@KGH001 WHERE 기준년월일 IN ('20120426','20120427');
CREATE TABLE TSKGHSE64 TABLESPACE DATA1 AS SELECT * FROM INST1.TSKGHSE64@KGH001 WHERE 기준년월일 IN ('20120426','20120427');
...
-- KGH000Y
CREATE TABLE TSKGHFE01 TABLESPACE DATA1 AS SELECT * FROM KGH000Y.TSKGHFE01@KGH001 WHERE 체결년월일 IN ('20110111','20110112');
CREATE TABLE TSKGHFD01 TABLESPACE DATA1 AS SELECT * FROM KGH000Y.TSKGHFD01@KGH001 WHERE 처리년월일 IN ('20110111','20110112');
CREATE TABLE TSKGHFF05 TABLESPACE DATA1 AS SELECT * FROM KGH000Y.TSKGHFF05@KGH001 WHERE 평가년월일 IN ('20110111','20110112');
CREATE TABLE TSKGHFF01 TABLESPACE DATA1 AS SELECT * FROM KGH000Y.TSKGHFF01@KGH001 WHERE 처리년월일 IN ('20110111','20110112');



INSERT INTO TSKGHFE01 SELECT * FROM INST1.TSKGHFE01@KGH001 WHERE 체결년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFD01 SELECT * FROM INST1.TSKGHFD01@KGH001 WHERE 처리년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFD02 SELECT * FROM INST1.TSKGHFD02@KGH001 WHERE 처리년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFD05 SELECT * FROM INST1.TSKGHFD05@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFD06 SELECT * FROM INST1.TSKGHFD06@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFD11 SELECT * FROM INST1.TSKGHFD11@KGH001 WHERE 처리년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFC41 SELECT * FROM INST1.TSKGHFC41@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHFF05 SELECT * FROM INST1.TSKGHFF05@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSA04 SELECT * FROM INST1.TSKGHSA04@KGH001 WHERE 처리년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE07 SELECT * FROM INST1.TSKGHSE07@KGH001 WHERE 거래년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE16 SELECT * FROM INST1.TSKGHSE16@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE17 SELECT * FROM INST1.TSKGHSE17@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE18 SELECT * FROM INST1.TSKGHSE18@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE19 SELECT * FROM INST1.TSKGHSE19@KGH001 WHERE 평가년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE54 SELECT * FROM INST1.TSKGHSE54@KGH001 WHERE 기준년월일 IN ('20120427','20120427');
INSERT INTO TSKGHSE64 SELECT * FROM INST1.TSKGHSE64@KGH001 WHERE 기준년월일 IN ('20120427','20120427');
...
DELETE FROM TSKGHFE01 WHERE 체결년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFD01 WHERE 처리년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFD02 WHERE 처리년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFD05 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFD06 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFD11 WHERE 처리년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFC41 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHFF05 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE07 WHERE 거래년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE16 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE17 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE18 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE19 WHERE 평가년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE54 WHERE 기준년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
DELETE FROM TSKGHSE64 WHERE 기준년월일 IN ('20120501','20120502','20120503','20111102','20110105','20110106','20110113');
...
d:\d\Documents\국민은행\소스\sqlplus KGH001/ybk34910

-- etc.bat
@d:\d\Documents\국민은행\소스\sp\bak\201206290912\PK_KGH_USER.sql;
@d:\d\Documents\국민은행\소스\sp\bak\201206290912\PK_KGH_USER_TYPE.sql;
exit;
...
-- DB LINK
-----------------------
PUBLIC  KGHPKG.REGRESS.RDBMS.DEV.US.ORACLE.COM  KGHPKG  DSKGHT01        2012. 2. 14 오후 2:18:44
PUBLIC  KGH001.REGRESS.RDBMS.DEV.US.ORACLE.COM  KGH001  DSKGHT01        2012. 2. 14 오후 2:18:54
...
PK_KGH_GV 아래정보 수동 설치(PC_KGH_CP_LOG_FILE I_파일명 NULL 오류 방지)
    로그파일명        VARCHAR(50):= 'PSH';
    로그정보          VARCHAR(100):= 'PSH';

2012.07.04 02번 순간적으로 INVALID 오브젝트 미 컴파일 오류
